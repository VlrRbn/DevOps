...
1. **Безопасно завершить по имени**
...
1. **Открытые файлы и сокеты процесса**
...
1. **Ограничить память процессу (root, scope)**
