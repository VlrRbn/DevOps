...
variable "tf_state_key" {
  ...
  validation {
    condition     = var.tf_state_key == "lab75/prod/full/terraform.tfstate"
    error_message = "This root module accepts only tf_state_key = \"lab75/prod/full/terraform.tfstate\"."
  }
}
